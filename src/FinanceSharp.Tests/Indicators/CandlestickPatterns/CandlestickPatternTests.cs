...
namespace FinanceSharp.Tests.Indicators.CandlestickPatterns {
    ...
    public class CandlestickPatternTests {
        ...
        public void ComparesAgainstExternalData(IndicatorBase indicator, string columnName, string testFileName) {
        ...
        private static Action<IndicatorBase, double> Assertion {
            get {
