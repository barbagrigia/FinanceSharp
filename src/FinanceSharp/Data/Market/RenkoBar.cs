...
//    /// </summary>
//    public class DoubleArray : BaseData, DoubleArray {
//        /// <summary>
...
//        /// 	 Gets the end time of this renko bar or the most recent update time if it <see cref="IsClosed"/>
//        /// </summary>
//        [Obsolete("DoubleArray.End is obsolete. Please use DoubleArray.EndTime property instead.")]
//        public DateTime End {
//            get { return EndTime; }
//            set { EndTime = value; }
//        }
...
//        /// <summary>
//        /// 	 Initializes a new default instance of the <see cref="DoubleArray"/> class.
//        /// </summary>
//        public DoubleArray() { }

//        /// <summary>
//        /// 	 Initializes a new instance of the <see cref="DoubleArray"/> class with the specified values
//        /// </summary>
...
//        public DoubleArray(DateTime time, double brickSize,
...
//        public DoubleArray(DateTime start, DateTime endTime,
...
//        /// <summary>
//        /// 	 Updates this <see cref="DoubleArray"/> with the specified values and returns whether or not this bar is closed
//        /// </summary>
...
//                throw new InvalidOperationException("A \"Wicked\" DoubleArray cannot be updated!");
