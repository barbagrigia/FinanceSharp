...
namespace FinanceSharp.Data {
    ...
    public class DataRollingWindow<T> : IReadOnlyWindow<T>, IIndicator where T : unmanaged {
        ...
        public DataRollingWindow(int size, int properties, string name = "") {
            if (size < 1) {
        ...
        /// </summary>
        public virtual int Properties => _properties;

        /// <summary>
        ///     The number of properties of input argument of <see cref="Add"/> must have.
        /// </summary>
        public int InputProperties => _properties;
        ...
        public void Add(long time, T item) {
            ...
            //TODO: this is a rolling window, Current should be the window. DoubleArray should have an overload that size is an actual array.
