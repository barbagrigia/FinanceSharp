...
namespace FinanceSharp.Indicators {
    ...
    public class ParabolicStopAndReverse : BarIndicator {
        ...
        private double _af;
        private readonly double _afInit;
        ...
        public ParabolicStopAndReverse(string name, double afStart = 0.02d, double afIncrement = 0.02d, double afMax = 0.2d)
            : base(name) {
            _afInit = afStart;
            _af = afStart;
        ...
        /// <param name="afIncrement">Acceleration factor increment value</param>
        /// <param name="afMax">Acceleration factor max value</param>
        public ParabolicStopAndReverse(double afStart = 0.02d, double afIncrement = 0.02d, double afMax = 0.2d)
