...
namespace FinanceSharp.Indicators.CandlestickPatterns {
    ...
    public static class CandleSettings {
        ...
        private static readonly Dictionary<CandleSettingType, CandleSetting> DefaultSettings = new Dictionary<CandleSettingType, CandleSetting> {
            {CandleSettingType.BodyLong, new CandleSetting(CandleRangeType.RealBody, 10, 1d)},
            {CandleSettingType.BodyVeryLong, new CandleSetting(CandleRangeType.RealBody, 10, 3d)},
            {CandleSettingType.BodyShort, new CandleSetting(CandleRangeType.RealBody, 10, 1d)},
            {CandleSettingType.BodyDoji, new CandleSetting(CandleRangeType.HighLow, 10, 0.1d)},
            {CandleSettingType.ShadowLong, new CandleSetting(CandleRangeType.RealBody, 0, 1d)},
            {CandleSettingType.ShadowVeryLong, new CandleSetting(CandleRangeType.RealBody, 0, 2d)},
            {CandleSettingType.ShadowShort, new CandleSetting(CandleRangeType.Shadows, 10, 1d)},
            {CandleSettingType.ShadowVeryShort, new CandleSetting(CandleRangeType.HighLow, 10, 0.1d)},
            {CandleSettingType.Near, new CandleSetting(CandleRangeType.HighLow, 5, 0.2d)},
            {CandleSettingType.Far, new CandleSetting(CandleRangeType.HighLow, 5, 0.6d)},
            {CandleSettingType.Equal, new CandleSetting(CandleRangeType.HighLow, 5, 0.05d)}
        };
    ...
    public class CandleSetting {
        ...
        /// </summary>
        public CandleRangeType RangeType { get; private set; }

        /// <summary>
        /// 	 The number of previous candles to average
        /// </summary>
        public int AveragePeriod { get; private set; }
