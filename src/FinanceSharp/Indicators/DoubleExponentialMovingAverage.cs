...
namespace FinanceSharp.Indicators {
    ...
    public class DoubleExponentialMovingAverage : IndicatorBase {
        ...
        public DoubleExponentialMovingAverage(string name, int period, double volumeFactor = 1d)
            : base(name) {
            _period = period;
        ...
        /// <param name="period">The period of the DEMA</param>
        /// <param name="volumeFactor">The volume factor of the DEMA (value must be in the [0,1] range, set to 1 for standard DEMA)</param>
        public DoubleExponentialMovingAverage(int period, double volumeFactor = 1d)
        ...
        /// </summary>
        public override int WarmUpPeriod => 1 + 2 * (_period - 1);
