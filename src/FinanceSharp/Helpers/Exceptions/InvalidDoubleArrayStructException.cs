...
namespace FinanceSharp.Exceptions {
    [Serializable]
    public class InvalidDoubleArrayStructException : Exception {
        /// <summary>Initializes a new instance of the <see cref="T:System.Exception"></see> class.</summary>
        public InvalidDoubleArrayStructException() { }
        ...
        public InvalidDoubleArrayStructException(string message) : base(message) { }
        ...
        public InvalidDoubleArrayStructException(string message, Exception innerException) : base(message, innerException) { }
    }
}