...
namespace FinanceSharp.Exceptions {
    public class IndicatorNotUpdatableDirectlyException : Exception {
        /// <summary>Initializes a new instance of the <see cref="T:System.Exception"></see> class.</summary>
        public IndicatorNotUpdatableDirectlyException() { }
        ...
        public IndicatorNotUpdatableDirectlyException(string message) : base(message) { }
        ...
        public IndicatorNotUpdatableDirectlyException(string message, Exception innerException) : base(message, innerException) { }
    }
}