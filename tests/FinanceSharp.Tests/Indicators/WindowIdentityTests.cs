    ...
    public class WindowIdentityTests {
        ...
        public void WindowIdentityComputesCorrectly() {
            ...
            for (int i = 0; i < data.Length; i++) {
                var datum = data[i];
                seen.Add(datum);
                indicator.Update(DateTime.Now.AddSeconds(i), new IndicatorValue(datum));
        ...
        public void IsReadyAfterPeriodUpdates() {
            ...
            indicator.Update(DateTime.UtcNow, 1d);
            indicator.Update(DateTime.UtcNow, 1d);
        ...
        public void ResetsProperly() {
            ...
            indicator.Update(DateTime.UtcNow, 2.0d);
            Assert.AreEqual(indicator.Current.Value, 2.0d);
        }
